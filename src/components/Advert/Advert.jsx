  ...
  return (
    <AdvertCard>
      ...
      <MainWrap>
        ...
        <CatecoriesList>
          <li>
            <Category iconName="icon-users" text={`${data.adults} adults`} />
          </li>
          <li style={{ textTransform: 'capitalize' }}>
            <Category iconName="icon-transmission" text={data.transmission} />
          </li>
          <li style={{ textTransform: 'capitalize' }}>
            <Category iconName="icon-petrol" text={data.engine} />
          </li>
        ...
        <MoreButton type="button">Show more</MoreButton>
      </MainWrap>
    </AdvertCard>
  );
};
